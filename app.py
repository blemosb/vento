...
def index():
    ...
    def setup(numero_jogadores):
        ...
        ilha.extend([
            ["|Baralho Tesouro" + str(len(baralho_tesouros)).center(5),
             "| Baralho Alagamento " + str(len(baralho_alagamento)).center(1) + " ",
             "  Descarte Tesouro" + str(len(baralho_descarte_tesouro)).center(5),
             "  Descarte Alagamento " + str(len(baralho_descarte_alagamento)) + "  ",
             " Nível de Enchente = 1".center(16) + " "]
        ])
    ...
    # Renderize a página HTML com o jogo
